...
//
//
//const std::string months[12] = { "March", "April", "May", "June", "July", "August", "September",
//                            "October", "November", "December", "January", "february" };
//const int md_num[12] = { 31,30,31,30,31,31,30,31,30,31,31,28 };
//
//const std::string css = R"(<style>
//table, th, td, caption {
...
//
//
//std::string calHead = "<h1> Gregorian Calendar </h1>";
//
//std::string monthBody(const std::string& month)
//{
...
//
//
//std::string weekDays(int day, int num, int& weekNum)
//{
...
//}
//
//void htmlHead(std::ofstream& myFile)
//{
//    myFile << "<!DOCTYPE html><html><head>" << css << "</head><body>";
//}
//
//void monthGenerator(std::ofstream& myFile, std::string year)
//{
...
//
//        if(i == 10)
//            myFile << monthBody(months[i]) << weekNames << weekDays(W, md_num[i], weekNum); // Jan
//        else // Feb
//        {
...
//        if (W < 0) W += 7;
//        if (W == 0) W = 7;
//        myFile << monthBody(months[i]) << weekNames << weekDays(W, md_num[i], weekNum);
//    }
//
//}
//
//void adjYears(std::ofstream& myFile, std::string year)
//{
//    int y = std::stoi(year);
//    for (int i = -1; i <= 1; i++) {
...
//}
//
//void htmlEnd(std::ofstream& myFile)
//{
//    myFile << "</body></html>";
//    myFile.close();
//}
